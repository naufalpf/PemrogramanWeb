...
<ul class="topnav">
			...
			<li><a href="quiz.php">Quiz</a></li>
				<li><a href="input.php">Jual Diri</a></li>
	</ul>
...
<div id="mainContainer">
		<div id="content"><form action="output.php" method="post" name="form1" id="form1">
  <p>Masukkan nama anda:
  <input type="text" name="namaanda" id="namaanda" />
  </p>
  <p>Masukkan alamat anda:
  <input type="text" name="alamat" id="alamat" />
  </p>
  <p>Masukkan tingkat sertifikat anda:
  <input type="text" name="tingkat" id="tingkat" />
  </p>
  <p>Masukkan TTL anda:
  <input type="date" name="ttlanda" id="ttlanda" />
  </p>
    <p>Apakah kemampuan khusus anda:
