        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation"> 
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul id="top-menu" class="nav navbar-nav navbar-right main_nav">
              ...
              <li><a href="#contactFeature">Kontak</a></li>    
                        ...
                        <?php
                            if(isset($_SESSION['msg']))
                            {
                              if($_SESSION['msg']=="fail")
                              {
                                ...
                                echo '<div class="alert alert-danger" role="alert">'.'<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true">'.'</span>'.'<span class="sr-only">'.'Error:'.'</span>'.'Enter a valid email address and password'.'</div>';
                              }
                            }
                          ?>
                          <form class="form" role="form" method="post" action="login.php" accept-charset="UTF-8">
                            <div class="form-group">
                               <label class="sr-only" for="exampleInputEmail2">Email address/Username</label>
                               <input type="username" class="form-control" name="username" id="username" placeholder="Email address/Username" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" value="Masuk" id="Masuk" name="Masuk" class="btn btn-primary btn-block">Sign in</button>
                            </div>
                              <div class="bottom text-center">
                Belum bergabung? <a href="register.php"><b>Register</b></a>
          ...
          <ul class="slides-container">
            ...
            <li>
              ...
              <div class="slider_caption">
                ...
                <p>The founder of Fodensi e-Learning Website. Karena hidup untuk berbagi.</p>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="about_area">
              <!-- START ABOUT HEADING -->
              <div class="heading">
                <h2 class="wow fadeInLeftBig">About Naufal</h2>
                          ...
                          <div class="panel-heading">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                 <span class="fa fa-check-square-o"></span>Naufal Pranasetyo Fodensi
                              </a>
                            </h4>
                          </div>
                          <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                            Seorang laki-laki yang lahir 4 Desember 1997, mempunyai jiwa sosial yang agak tinggi namun sedikit kurang peka terhadap lingkungan</div>
                          </div>
                        </div>
                          ...
                          <div class="panel-heading">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                 <span class="fa fa-check-square-o"></span>Pendidikan
                              </a>
                            </h4>
                          </div>
                          <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                           Alhamdulillah, sekarang sedang menjalani perkuliahan di Departemen Informatika ITS. Doakan Ia dapat lulus tepat waktu.</div>
                          </div>
                        </div>
                          ...
                          <div class="panel-heading">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                <span class="fa fa-check-square-o"></span>Mengapa web ini dibentuk?
                              </a>
                            </h4>
                          </div>
                          <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                             Naufal mempunyai rasa tanggap dan kepedulian yang tidak sedikit, ia ingin semua orang mempunyai pendidikan walaupun yang tak dapat bersekolah sekalipun</div>
                          </div>
                        </div>
                          ...
                          <div class="panel-heading">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
                                <span class="fa fa-check-square-o"></span>Aamiin
                              </a>
                            </h4>
                          </div>
                          <div id="collapseFour" class="panel-collapse collapse">
                            <div class="panel-body">
                            Doakan agar web ini dapat bermanfaat, bagi siapapun yang memakai maupun meledeknya.</div>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="team_slider">  
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    ...
                    <h5 class="">Naufal Pranasetyo</h5>
                    <span>Founder</span>                        
                    <p>Pencetus ide terbentuknya website ini</p>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    ...
                    <span>Manager</span>                        
                    <p>Partner pak Naufal, sahabat sejak kecilnya.</p>
                    <div class="team_social">
                      <a href="#"><i class="fa fa-facebook"></i></a>
                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    ...
                    <h5>Sir Fodensi</h5>
                    <span>Developer</span>                        
                    <p>Pengembang agar website ini mendunia</p>
                    <div class="team_social">
                      <a href="#"><i class="fa fa-facebook"></i></a>
                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    ...
                    <span>Designer</span>                        
                    <p>Petugas front-end. Desain agar web ini minimalis.</p>
                    <div class="team_social">
                      <a href="#"><i class="fa fa-facebook"></i></a>
                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="img/team-6.jpg" alt="img">
                    </div>
                    <h5>Djohan Prabowo</h5>
                    <span>Programmer</span>                        
                    <p>Sang ahli di bidangnya, kepercayaan pak Naufal</p>
                    <div class="team_social">
                      <a href="#"><i class="fa fa-facebook"></i></a>
                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    <div class="team_img">
                      <img src="img/team-7.jpg" alt="img">
                    </div>
                    <h5>Adit Cahyo</h5>
                    <span>Analisis</span>                        
                    <p>Ya seperti itulah kerjaannya, semoga dia berguna</p>
                    <div class="team_social">
                      <a href="#"><i class="fa fa-facebook"></i></a>
                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="single_team wow fadeInUp">
                    ...
                    <p>Pemasaran, bertanggung jawab pada publikasi perusahaan</p>
                    <div class="team_social">
                      <a href="#"><i class="fa fa-facebook"></i></a>
                      <a href="#"><i class="fa fa-twitter"></i></a>
                      <a href="#"><i class="fa fa-google-plus"></i></a>
              ...
              <ul class="testimonial_slider">
                ...
                <li>
                  <div class="media testi_media">
                    <a class="media-left testi_img" href="#">
                      <img src="img/team-8.jpg" alt="img">
                    </a>
                ...
                <li>
                  <div class="media testi_media">
                    ...
                    <div class="media-body">
                      <h4 class="media-heading">Boss Azka</h4>
                      <span>CEO</span>                      
                    </div>
                  </div>
                  <div class="testi_content">
                ...
                <li>
                  <div class="media testi_media">
                    <a class="media-left testi_img" href="#">
                      <img src="img/team-9.jpg" alt="img">
                    </a>
                    <div class="media-body">
