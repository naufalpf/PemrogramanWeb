...
if($num_of_slides <> 0){
	...
	$slides[] = array('image'=>'main/img/slide01.jpg','title'=>get_lang('YourTitle1'),'link'=>'#','caption'=>get_lang('Semua konten dapat diakses dengan mudah serta interface yang friendly-user'),'alttext'=>get_lang('AltText1'));
	$slides[] = array('image'=>'main/img/slide02.jpg','title'=>get_lang('YourTitle2'),'link'=>'#','caption'=>get_lang('Diisi oleh pengajar yang berpengalaman dan bersertifikat Internasional'),'alttext'=>get_lang('AltText2'));
	$slides[] = array('image'=>'main/img/slide03.jpg','title'=>get_lang('YourTitle3'),'link'=>'#','caption'=>get_lang('Website sangat interaktif dan dinamis dan dapat berinteraksi langsung serta tutor'),'alttext'=>get_lang('AltText3'));
}
