...
require_once('Classes/MascotManager.php');

//default path is /
$relative = '/mascot/';
$manager = new MascotManager($IMConfig);
...
<?php } ?>
	...
	{
		var url = "<?php echo api_get_path(REL_CODE_PATH).'inc/lib/fckeditor/editor/plugins/MascotManager/'; ?>editor.php?img="+image;
