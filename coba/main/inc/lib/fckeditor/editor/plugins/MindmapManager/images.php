...
require_once('Classes/MindmapManager.php');

//default path is /
$relative = '/mindmaps/';
$manager = new MindmapManager($IMConfig);
...
<?php } ?>
	...
	{
		var url = "<?php echo api_get_path(REL_CODE_PATH).'inc/lib/fckeditor/editor/plugins/MindmapManager/'; ?>editor.php?img="+image;
